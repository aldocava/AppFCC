<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark navbar-brand-center">
    ...
    <div class="collapse navbar-collapse navbar-right" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link navbar-right" href="<?php echo base_url('Profesor/creaAnuncio'); ?>">Crear Anuncio</a>
            </li>
            <li class="nav-item">
                <a class="nav-link navbar-right" href="<?php echo base_url('Profesor/misAnuncios') ?>">Mis anuncios</a>
            </li>
        </ul>
